      ...
      <div className="max-w-5xl mx-auto px-6 flex flex-col items-center gap-8">
        ...
        <div className="w-full flex flex-col md:flex-row justify-between items-center gap-6">
          <div className="flex items-center gap-2">
            <img src="/logo.png" alt="Light IMG Logo" className="h-10 w-auto grayscale opacity-50" width="40" height="40" />
            <span className="font-semibold text-gray-500">Light <span className="font-extrabold">IMG</span></span>
          </div>
